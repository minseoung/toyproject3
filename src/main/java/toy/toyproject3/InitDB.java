...
public class InitDB {
    ...
    public void init() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Board board1 = new Board("유재석의 출석체크" + (i+1), "안녕하세요~!", member1, uploadFiles);
            Board board2 = new Board("박명수의 출석체크" + (i+1), "안녕하세요~!", member2, uploadFiles);
            Board board3 = new Board("정준하의 출석체크" + (i+1), "안녕하세요~!", member3, uploadFiles);
            Board board4 = new Board("정형돈의 출석체크" + (i+1), "안녕하세요~!", member4, uploadFiles);
            Board board5 = new Board("하동훈의 출석체크" + (i+1), "안녕하세요~!", member5, uploadFiles);
            Board board6 = new Board("노홍철의 출석체크" + (i+1), "안녕하세요~!", member6, uploadFiles);
